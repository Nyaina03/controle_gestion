...
function VisualisationFonctionnement() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:8000/api/budget/visualisation_fonctionnement/?code_programme=${programme}&annee=${annee}&tri=${tri}`
      );
    ...
    <div className="dashboard-page">
      ...
      <div className="main-content">
        ...
        <div className="form-container">
          <h2 className="div-h2">Visualisation des Fonctionnements (Classe 6)</h2>
...
export default VisualisationFonctionnement;
